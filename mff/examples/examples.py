...
def example1(): # no constraints
    ...
    print("\nLast few rows before forecasting (showing missing values):\n", df.tail())
...
def example3():
    ...
    print("\n Forecasted Output Annual Data:\n", df2_list[0].tail())
    print("\n Forecasted Output Quarterly Data:\n", df2_list[1].tail())
...
def france(): 
    df_true = pd.read_excel(r'mff\data\final_data.xlsx', index_col=0)
